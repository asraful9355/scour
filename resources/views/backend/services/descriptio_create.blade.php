   ...
   <div id="content">
      ...
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-2 text-gray-800 text-right">
         ...
         <!-- DataTales Example -->
         <div class="row">
            <form method="post" action="{{ route('services.description.store') }}" enctype="multipart/form-data">
              @csrf
               <div class="col-md-10 offset-1">
                  <div class="card shadow mb-4">
                     <div class="card-body">
                        <h4>Service Description Create</h4>
                        <hr>
                        <div class="row">
                           ...
                           <div class="form-group">
                              ...
                              <textarea name="service_descrption_en" id="service_descrption_en" cols="30" rows="7" class="form-control summernote"></textarea>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea name="service_descrption_bn" id="service_descrption_bn" cols="30" rows="7" class="form-control summernote"></textarea>
