   ...
   <div id="content">
      ...
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-2 text-gray-800 text-right">
         ...
         <!-- DataTales Example -->
         <div class="row">
            <form method="post" action="{{ route('about.description.store') }}">
              @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea name="about_descrption_en" id="about_descrption_en" cols="30" rows="7" class="form-control summernote"></textarea>
                           ...
                           <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea name="about_descrption_bn" id="about_descrption_bn" cols="30" rows="7" class="form-control summernote"></textarea>
