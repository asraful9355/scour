                        ...
                        <div class="row">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              @enderror
                              <div class="mb-2">
                                <img id="showImage" class="rounded avatar-lg showImage" src="{{ asset($team->image) }}" alt="No Image" width="100px" height="80px;">
                              </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="name_en" value="{{ $team->name_en }}" id="name_en" class="form-control">
                              @error('name_en')
                                <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="name_bn" value="{{ $team->name_bn }}" id="name_bn" class="form-control">
                              @error('name_bn')
                                <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="title_en" value="{{ $team->title_en }}" id="title_en" class="form-control">
                              @error('title_en')
                                <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="title_bn" value="{{ $team->title_bn }}" id="title_bn" class="form-control">
                              @error('title_bn')
                                <span class="text-danger">{{ $message }}</span>
                              @enderror
                            </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="behance_url" value="{{ $team->behance_url }}" id="behance_url" class="form-control">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <label for="envelope_url">Envelope (URL): <span class="text-danger">*</span></label>
                              <input type="text" name="envelope_url" value="{{ $team->envelope_url }}" id="envelope_url" class="form-control">
                            </div>
                          </div>
