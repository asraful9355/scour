   ...
   <div id="content">
      ...
      <div class="container-fluid">
        ...
        <h1 class="h3 mb-2 text-gray-800 text-right">
         ...
         <!-- DataTales Example -->
         <div class="row">
            <form method="post" action="{{ route('project.description.update',$description->id)}}" >
              @csrf
               <div class="col-md-10 offset-1">
                  <div class="card shadow mb-4">
                     <div class="card-body">
                        <h4>Project Descripotion Edit</h4>
                        <hr>
                        <div class="row">
                          ...
                          <div class="col-md-12">
                              <div class="form-group">
                                ...
                                <textarea name="featured_project_descrption_en" id="featured_project_descrption_en" cols="30" rows="7" class="form-control summernote"> {{ $description->featured_project_descrption_en }} </textarea>
                           ...
                           <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="featured_project_descrption_bn" id="featured_project_descrption_bn" cols="30" rows="7" class="form-control summernote"> {{ $description->featured_project_descrption_bn }} </textarea>
